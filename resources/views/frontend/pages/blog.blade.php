                ...
                <div class="row align-items-stretch retro-layout-2">
                    <div class="col-md-4">
                        ...
                        <a href="single.html" class="h-entry v-height gradient"
                           style="background-image: url('{{asset('storage/images/img_2.jpg')}}');">
                    ...
                    <div class="col-md-4">
                        <a href="single.html" class="h-entry img-5 h-100 gradient"
                           style="background-image: url('{{asset('storage/images/img_v_1.jpg')}}');">
                    ...
                    <div class="col-md-4">
                        <a href="single.html" class="h-entry mb-30 v-height gradient"
                           style="background-image: url('{{asset('storage/images/img_3.jpg')}}');">
                        ...
                        <a href="single.html" class="h-entry v-height gradient"
                           style="background-image: url('{{asset('storage/images/img_4.jpg')}}');">
