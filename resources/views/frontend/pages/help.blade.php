...
@section('home_content')
    <section class="parallax-container" data-parallax-img="{{asset('storage/images/help.jpeg')}}">
        <div class="parallax-content breadcrumbs-custom context-dark">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12 col-lg-9">
                        <h2 class="breadcrumbs-custom-title">Emergency Help</h2>
                        <ul class="breadcrumbs-custom-path">
                            <li><a href="{{route('frontSide')}}">Home</a></li>
                            <li class="active">Emergency Help</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row row-50">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="box-icon-classic">
                        ...
                        <div class="box-icon-caption">
                            <h4><a href="mailto:#">01730 324801</a></h4>
                            <p>Free Free Ambulance service</p>
                        </div>
                    </div>
                </div>
            </div>
